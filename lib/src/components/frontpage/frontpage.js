        ...
        return(
            ...
            <div className = 'frontText'>
              ...
              <IconContext.Provider value={{ color: "white", size: "1.5em" }}>
                <div className="frontIcon" style = {{ marginTop: '30px'}}>
                   {/* TODO<Link to='/about' className="nav-link" href="/about">About</Link> */}
                   <a href="https://github.com/jschriemer/Librario"> <FaGithub /></a>
                </div>
          ...
          <Delay wait={6000} >
            ...
            <SvgLines animate={ true }
              ...
              stagger={1000}
              timing="linear" >
              <svg width="5.55556in" height="4.55556in" viewBox="0 0 500 500">
                <path id="Imported Path" fill="none" stroke="white" strokeWidth="10"
                      d="M 71.69,123.51
