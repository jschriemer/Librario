          ...
          <nav className="navbar navbar-expand" style ={{background: 'black'}}>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <Link to= '/profile' className="nav-link profile" href="/profile" style = {{float: 'right'}}>{this.avatargen()}</Link>
                </li>
                <li className="nav-item">
                  <Link to='/friends' className="nav-link" href="/friends">Friends</Link>
                </li>
                <li className="nav-item">
                  <Link to='/friendslist' className="nav-link" href="/friends">Friend List</Link>
                </li>
                <li className="nav-item">
